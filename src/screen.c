...
cvar_t		scr_conspeed = {"scr_conspeed", "2000", CVAR_NONE};
...
cvar_t		_scr_scaling = {"scr_scaling", "5", CVAR_ARCHIVE};
...
// 
	...
	{ 
		pcxname[5] = i/10 + '0'; 
		pcxname[6] = i%10 + '0'; 
		Q_snprintf (checkname, sizeof(checkname), "%s/%s", com_gamedir, pcxname);
